...
export class Footer {
	...
	rawHtml = `
			...
			<h4>Ut proverbia non nulla veriora sint quam vestra dogmata.</h4>
			...
			<h3>An hoc usque quaque, aliter in vita?</h3>
			<ol>
			...
			<h4>Claudii libidini, qui tum erat summo ne imperio, dederetur.</h4>
